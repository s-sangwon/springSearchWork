...
<center>
	<c:if test="${ sessionScope.loginMember.admin eq 'Y' }">
	 <button onclick="javascript:location.href='${pageContext.servletContext.contextPath}/movewrite.do'">
	새 공지글 등록</button>
	</c:if>
</center>
<!-- 검색 항목 영역 -->
...
<br>
<center>
	<button onclick="javascript:location.href='${pageContext.servletContext.contextPath}/nlist.do';">전체 목록 보기
</center>
<br>
<table align="center" width="500" border="1" cellspacing="0" cellpadding="1">
	...
	<c:forEach items="${ requestScope.list}" var="n">
		<tr align="center">
			...
			<td><fmt:formatDate value="${ n.noticedate }" pattern="yyyy-MM-dd"/>
			</td>
		</tr>
	</c:forEach>
</table>
